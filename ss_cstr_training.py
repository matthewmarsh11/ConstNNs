...
def main():
    ...
    # pinn, pinn_history, pinn_avg_loss = pinn_trainer.train(X_train, y_train, X_test, y_test, X_val_unconst, y_val, criterion)

    kkt_save.save_full_model(kkt_ppinn, 'models/cstr_kkt_ppinn')
    mlp_save.save_full_model(mlp, 'models/cstr_mlp')
    ec_save.save_full_model(ec_nn, 'models/cstr_ec_nn')
    # pinn_trainer.save_full_model('models/cstr_pinn')
